...
def bind():
    ...
    _attrs_4352100368 = _loads('(dp1\n.')
    _attrs_4352099600 = _loads('(dp1\nVaction\np2\nV\nsVmethod\np3\nVPOST\np4\nsVenctype\np5\nVmultipart/form-data\np6\ns.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_4352100112 = _loads('(dp1\nVname\np2\nV_method\np3\nsVtype\np4\nVhidden\np5\nsVvalue\np6\nVPUT\np7\ns.')
    _attrs_4352100240 = _loads('(dp1\n.')
...
__filename__ = u'/Users/gawel/py/pyramid_formalchemy/pyramid_formalchemy/templates/admin/edit.pt'
