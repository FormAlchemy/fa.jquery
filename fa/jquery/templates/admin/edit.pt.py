...
def bind():
    ...
    _attrs_4367087248 = _loads('(dp1\nVclass\np2\nVfa_controls\np3\ns.')
    _attrs_4367087120 = _loads('(dp1\nVname\np2\nVnext\np3\nsVvalue\np4\nV\nsVtype\np5\nVhidden\np6\nsVid\np7\nVnext\np8\ns.')
    _attrs_4367086608 = _loads('(dp1\n.')
    _attrs_4367086864 = _loads('(dp1\n.')
    _attrs_4367086992 = _loads('(dp1\nVname\np2\nV_method\np3\nsVtype\np4\nVhidden\np5\nsVvalue\np6\nVPUT\np7\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_4367086736 = _loads('(dp1\nVaction\np2\nV\nsVmethod\np3\nVPOST\np4\nsVenctype\np5\nVmultipart/form-data\np6\ns.')
    ...
    def render(econtext, rcontext=None):
        ...
        def _callback_main(econtext, _repeat, _out=_out, _write=_write, _domain=_domain, **_ignored):
            ...
            if (_tmp is not None):
                ...
                _write(_tmp)
            _write(u'</div>\n        ')
            attrs = _attrs_4367086992
            _write(u'<input type="hidden" name="_method" value="PUT" />\n        ')
            attrs = _attrs_4367087120
            u"u'\\n        '"
            _write(u'<input type="hidden" id="next" name="next" value="" />\n        ')
            _default.value = default = u'\n        '
            u'actions.render(request)'
            _content = _lookup_attr(econtext['actions'], 'render')(econtext['request'])
            attrs = _attrs_4367087248
            u'_content'
