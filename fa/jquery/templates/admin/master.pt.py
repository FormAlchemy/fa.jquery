...
def bind():
    ...
    _attrs_4362308560 = _loads('(dp1\n.')
    _lookup_attr = _loads('cchameleon.core.codegen\nlookup_attr\np1\n.')
    _attrs_4362307728 = _loads('(dp1\nVrel\np2\nVstylesheet\np3\ns.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_4362307600 = _loads('(dp1\n.')
    _attrs_4362308688 = _loads('(dp1\n.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_4362308944 = _loads('(dp1\nVid\np2\nVlanguages\np3\ns.')
    _attrs_4362307344 = _loads('(dp1\n.')
    _attrs_4362307536 = _loads('(dp1\n.')
    _attrs_4362307472 = _loads('(dp1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_4362307664 = _loads('(dp1\nVrel\np2\nVstylesheet\np3\ns.')
    _attrs_4362307984 = _loads('(dp1\nVtype\np2\nVtext/css\np3\ns.')
    _attrs_4362307856 = _loads('(dp1\nVtype\np2\nVtext/javascript\np3\ns.')
    _attrs_4362308112 = _loads('(dp1\nVid\np2\nVcontent\np3\nsVclass\np4\nVui-admin ui-widget\np5\ns.')
    _attrs_4362307920 = _loads('(dp1\nVtype\np2\nVtext/javascript\np3\ns.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_4362308752 = _loads('(dp1\n.')
    _attrs_4362307792 = _loads('(dp1\nVtype\np2\nVtext/javascript\np3\ns.')
    _attrs_4362308496 = _loads('(dp1\nVstyle\np2\nVdisplay:none;\np3\nsVid\np4\nVmodels\np5\ns.')
    _attrs_4362308304 = _loads('(dp1\n.')
    _attrs_4362308240 = _loads('(dp1\nVid\np2\nVheader\np3\nsVclass\np4\nVui-widget-header ui-corner-all\np5\ns.')
    _attrs_4362308432 = _loads('(dp1\n.')
    _attrs_4362309008 = _loads('(dp1\nVstyle\np2\nVdisplay:none\np3\nsVclass\np4\nVroot_url\np5\ns.')
    _attrs_4362308368 = _loads('(dp1\nVclass\np2\nVbreadcrumb\np3\ns.')
    def render(econtext, rcontext=None):
        ...
        if _tmp1:
            ...
            pass
            attrs = _attrs_4362307920
            _write(u'<script type="text/javascript"></script>')
        _write(u'\n      ')
        attrs = _attrs_4362307984
        ...
        attrs = _attrs_4362307536
        _write(u'<body>\n      ')
        attrs = _attrs_4362308112
        _write(u'<div id="content" class="ui-admin ui-widget">\n        ')
        attrs = _attrs_4362308240
        ...
        if _tmp1:
            pass
            attrs = _attrs_4362308432
            u"''"
            _write(u'<div>\n            ')
            _default.value = default = ''
            u'model_name'
            _content = econtext['model_name']
            attrs = _attrs_4362308688
