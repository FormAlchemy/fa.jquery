...
def bind():
    ...
    _attrs_4302028752 = _loads('(dp1\n.')
    _lookup_attr = _loads('cchameleon.core.codegen\nlookup_attr\np1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_4302082256 = _loads('(dp1\nVtype\np2\nVtext/javascript\np3\ns.')
    _attrs_4301882704 = _loads('(dp1\n.')
    _attrs_4302082192 = _loads('(dp1\nVrel\np2\nVstylesheet\np3\ns.')
    _attrs_4302082576 = _loads('(dp1\nVid\np2\nVheader\np3\nsVclass\np4\nVui-widget-header ui-corner-all\np5\ns.')
    _attrs_4301990736 = _loads('(dp1\n.')
    _attrs_4302028624 = _loads('(dp1\n.')
    _attrs_4302028496 = _loads('(dp1\n.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_4302082704 = _loads('(dp1\nVclass\np2\nVbreadcrumb\np3\ns.')
    _attrs_4301900048 = _loads('(dp1\n.')
    _attrs_4302082128 = _loads('(dp1\nVrel\np2\nVstylesheet\np3\ns.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_4302082320 = _loads('(dp1\nVtype\np2\nVtext/css\np3\ns.')
    _attrs_4302028688 = _loads('(dp1\n.')
    _attrs_4301883408 = _loads('(dp1\n.')
    _attrs_4302082448 = _loads('(dp1\nVid\np2\nVcontent\np3\nsVclass\np4\nVui-admin ui-widget\np5\ns.')
    ...
    def render(econtext, rcontext=None):
        ...
        if _tmp1:
            ...
            pass
            attrs = _attrs_4301883408
            _write(u'<div>\n        </div>')
        _write(u'\n      </div>\n    </body>\n</html>')
        return
    return render

__filename__ = u'/Users/gawel/py/formalchemy_project/fa.jquery/fa/jquery/templates/admin/master.pt'
