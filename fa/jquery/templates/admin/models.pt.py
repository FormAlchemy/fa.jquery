...
def bind():
    ...
    _attrs_4348143888 = _loads('(dp1\n.')
    _lookup_attr = _loads('cchameleon.core.codegen\nlookup_attr\np1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_4348144016 = _loads('(dp1\n.')
    _attrs_4348144272 = _loads('(dp1\n.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_4348144144 = _loads('(dp1\n.')
    ...
    def render(econtext, rcontext=None):
        ...
        def _callback_main(econtext, _repeat, _out=_out, _write=_write, _domain=_domain, **_ignored):
            ...
            for item in _tmp1:
                _tmp2 = (_tmp2 - 1)
                attrs = _attrs_4348144016
                _write(u'<div>\n        ')
                attrs = _attrs_4348144144
                u"''"
                _write(u'<div>\n          ')
                _default.value = default = ''
                u'item'
                _content = item
                attrs = _attrs_4348144272
                u"request.route_url('fa_admin', traverse=item)"
                _write(u'<a')
                _tmp3 = _lookup_attr(econtext['request'], 'route_url')('fa_admin', traverse=item)
...
__filename__ = u'/Users/gawel/py/pyramid_formalchemy/pyramid_formalchemy/templates/admin/models.pt'
