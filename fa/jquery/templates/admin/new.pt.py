...
def bind():
    ...
    def render(econtext, rcontext=None):
        ...
        def _callback_main(econtext, _repeat, _out=_out, _write=_write, _domain=_domain, **_ignored):
            ...
            attrs = _attrs_4354394256
            _write(u'<div>\n      ')
            attrs = _attrs_4354393040
            ...
            if (_tmp is not None):
                ...
                _write(_tmp)
            _write(u'</div>\n        ')
            attrs = _attrs_4354394320
            _write(u'<div class="fa_controls">\n          ')
            attrs = _attrs_4354395984
