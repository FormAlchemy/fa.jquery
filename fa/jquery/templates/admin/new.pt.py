...
def bind():
    ...
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_4352113296 = _loads('(dp1\n.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_4352112784 = _loads('(dp1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_4352113488 = _loads('(dp1\nVmethod\np2\nVPOST\np3\nsVenctype\np4\nVmultipart/form-data\np5\ns.')
    ...
    def render(econtext, rcontext=None):
        ...
        def _callback_main(econtext, _repeat, _out=_out, _write=_write, _domain=_domain, **_ignored):
            ...
            attrs = _attrs_4352112784
            _write(u'<div>\n      ')
            attrs = _attrs_4352113488
...
__filename__ = u'/Users/gawel/py/pyramid_formalchemy/pyramid_formalchemy/templates/admin/new.pt'
