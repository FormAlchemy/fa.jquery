...
def bind():
    ...
    _attrs_4353977616 = _loads('(dp1\n.')
    _lookup_attr = _loads('cchameleon.core.codegen\nlookup_attr\np1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_4353977872 = _loads('(dp1\n.')
    ...
    def render(econtext, rcontext=None):
        ...
        def _callback_main(econtext, _repeat, _out=_out, _write=_write, _domain=_domain, **_ignored):
            ...
            attrs = _attrs_4353977872
            u"''"
            _write(u'<div>\n      ')
            _default.value = default = ''
            u'fs.render()'
            _content = _lookup_attr(econtext['fs'], 'render')()
            attrs = _attrs_4353977616
            u'_content'
            _write(u'<div>')
            _tmp1 = _content
            _tmp = _tmp1
...
__filename__ = u'/Users/gawel/py/pyramid_formalchemy/pyramid_formalchemy/templates/admin/show.pt'
