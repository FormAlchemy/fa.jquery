...
def bind():
    ...
    _attrs_4356516432 = _loads('(dp1\n.')
    _lookup_attr = _loads('cchameleon.core.codegen\nlookup_attr\np1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_4356516496 = _loads('(dp1\n.')
    _attrs_4356516112 = _loads('(dp1\n.')
    _attrs_4356515984 = _loads('(dp1\nVclass\np2\nVfa_field ui-widget\np3\ns.')
    _attrs_4356517264 = _loads('(dp1\n.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_4356516880 = _loads('(dp1\nVclass\np2\nVfield_input\np3\ns.')
    _attrs_4356515792 = _loads('(dp1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_4356515536 = _loads('(dp1\n.')
    _attrs_4356516304 = _loads('(dp1\nVclass\np2\nVfa_instructions ui-corner-all\np3\ns.')
    _attrs_4356516176 = _loads('(dp1\nVclass\np2\nVlabel\np3\ns.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_4356516624 = _loads('(dp1\nVclass\np2\nVui-state-error ui-corner-all\np3\ns.')
